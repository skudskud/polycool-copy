...
- "Geopolitics" is for politics, elections, Trump, international relations, wars, conflicts, government, voting, political figures
- "Sports" includes all sports (NBA, NFL, MLB, soccer, esports, Counter-Strike, chess, athletics, championships, athletes)
- "Finance" is for business, economy, stocks, companies, IPOs, interest rates, Fed, economic indicators, corporate news
- "Crypto" includes all cryptocurrency, blockchain, Bitcoin, Ethereum, NFT, DeFi, Web3, crypto prices
- "Other" is for everything else: culture, entertainment, technology, science, AI, pop culture, celebrities, movies, music, art, health
    ...
    async def categorize_market(self, question: str, existing_category: Optional[str] = None) -> Optional[str]:
        ...
        try:
            ...
            response = client.chat.completions.create(
                model="gpt-4o-mini",  # Using OpenAI's standard mini model
                messages=[
            ...
            if category in self.CATEGORIES:
                ...
                if normalized:
                    ...
                    logger.warning(f"⚠️ Could not normalize category '{category}' for '{question[:50]}...' - defaulting to Other")
                    return "Other"

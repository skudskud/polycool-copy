...
from telegram_bot.handlers.smart_trading import (
    handle_smart_trading_command,
    handle_smart_callback as handle_smart_callback_impl
)
...
async def handle_smart_callback(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    """
    await handle_smart_callback_impl(update, context)

...
def fix_database_urls():
    ...
    # Correct URL template (using aws-1 region and real password from dashboard)
    correct_url = "postgresql://postgres.xxzdlbwfyetaxcmodiec:[YOUR-PASSWORD]@aws-1-eu-north-1.pooler.supabase.com:5432/postgres"

...
class Settings(BaseSettings):
    ...
    DB_UPSERT_BATCH_SIZE: int = 200
    DB_UPSERT_TIMEOUT_SECONDS: int = 120
    ...
    # ========================================
    POLL_MS: int = 300000  # 5 minutes (300 seconds) - OPTIMIZED to reduce Supabase egress (was 60s)
    GAMMA_API_URL: str = "https://gamma-api.polymarket.com/markets"
    POLYMARKET_API_URL: str = "https://clob.polymarket.com/markets"
    POLL_LIMIT: int = 100
    POLL_OFFSET_START: int = 0
    POLL_RATE_LIMIT_BACKOFF_MAX: int = 300  # 5 minutes max backoff

    # Progressive Rollout Configuration
    ROLLOUT_PERCENTAGE: int = 100  # Default: 100% (all markets)
    SHADOW_MODE: bool = False  # If True, log only without DB upsert
    ...
    # ========================================
    LOG_LEVEL: str = "INFO"  # DEBUG generates 500+ logs/sec and Railway drops them

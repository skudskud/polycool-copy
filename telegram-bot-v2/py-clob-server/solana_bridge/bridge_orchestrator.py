...
📤 Step 1: Bridge SOL → POL
• {sol_amount} SOL → ~{pol_received:.4f} POL

📥 Step 2: QuickSwap POL → USDC.e
• Swap: {pol_to_swap:.4f} POL → ~{estimated_usdc_after_swap:.2f} USDC.e
• Reserve: {MIN_POL_RESERVE} POL (for gas)

🎯 Final Result:
• ~{estimated_usdc_after_swap:.2f} USDC.e (for trading)
• {MIN_POL_RESERVE} POL (for gas)
